  ...
  <div :class="{'summary-item': !inDetail}">
    <div class="item-content">
      <div class="item-title" v-if="!inDetail">
        <!-- <div class="fr h">
          <view-button :params="postParams" path="replyStatus" :inCockpit="$attrs.inCockpit"></view-button>
...
export default {
    ...
    methods: {
        ...
        dataFn() {
            ...
            let columns = ['dimensionValue', 'totalAmountReplyMy', 'totalAmountReplyOther']
            return emailApi.getEmailReplyStatus(params).then(resp => {
                if (resp.success) {
                    let arr = []
                    this.totalNum = 0
